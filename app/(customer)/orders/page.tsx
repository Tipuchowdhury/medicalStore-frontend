...
export default function OrdersPage() {
  const orders = [
    ...
    },
    {
      ...
      status: 'Processing',
      items: [
        { name: 'Vitamin D 2000IU', quantity: 1 },
      ]
    },
  ]
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Tabs defaultValue="all">
                    ...
                    <div className="space-y-4">
                      <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-2xl font-bold text-primary mt-1">${order.total.toFixed(2)}</p>
                        </div>
                      </div>
            ...
            <TabsContent value="processing" className="space-y-4 mt-6">
              {orders
                .filter(o => o.status === 'Processing' || o.status === 'In Transit')
                .map((order) => (
                  <Card key={order.id}>
                    <CardHeader>
                      <div className="flex justify-between items-start">
